Shader "My/PostEffects/CameraMultiPass"
{
    Properties
    {
        _MainTex ("Texture", 2D) = "white" {}
        _Depth ("Depth", Range(0, 1)) = 1
        _Grayness ("GrayScaleAmount", Range(0, 1)) = 1.0

        _BlendTex ("Blend Texture", 2D) = "grunge_gray_12" {}
        _Opacity ("Opacity", Range(0, 1)) = 1

        _Brightness ("Brightness", Range(0, 1)) = 3
        _Saturation ("Saturation", Range(0, 1)) = 0
        _Contrast ("Contrast", Range(0, 1)) = 2.34
    }
    SubShader
    {
        // No culling or depth
